...
document.addEventListener('DOMContentLoaded', function(event) {
  cookieChoices.showCookieConsentBar('Questo sito utilizza i cookie per offrire i propri servizi. Se decidi di continuare la navigazione consideriamo che accetti il loro uso.',
  'OK', 'Informazioni.', './cookie-law');
});
...
console.log("Source code of my portfolio is open source :) see my account github: https://github.com/ptkdev");
